...
def minimize_partition(
    ...
    elif "essay" in input_dir:
        input_path = f"{input_dir}/essay_{name}.json"
    ...
    with open(input_path, "r") as input_file:
        ...
        for ins_id, instance in enumerate(instances):
            ...
            if not relations: # added by vishal for handling empty relations in the dataset
...
if __name__ == "__main__":
    ...
    # elif "ace05" in input_dir:
        ...
        typefile = f"{input_dir}/essay_types.json"
    ...
    for k in labels['components'].keys():
